   ...
   <!-- ========== Left Sidebar Start ========== -->
      @include('includes.submit_attendance')
      
      <div class="hidemenu left side-menu ">
                <div class="slimscroll-menu hidemenu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu" >
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                            <a href="/employees" class="waves-effect {{ request()->is("employees") || request()->is("/employees/*") ? "mm active" : "" }}"><i class="ti-user"></i><span class="title"> Employees </span></a>
                                <!-- <ul class="submenu">
                                    <li>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li class="">
                                <a href="#att" data-toggle="modal" class="waves-effect {{ request()->is("employee") || request()->is("employee/*") ? "mm active" : "" }}">
                                    <i class="ti-time"></i> <span> Submit Attendance </span>
                                </a>
                            ...
                            <li class="">
                                <a href="/logs" class="waves-effect {{ request()->is("logs") || request()->is("logs/*") ? "mm active" : "" }}">
                                    <i class="ti-calendar"></i> <span> Attendance Report </span>
                                </a>
                            </li>
