...
Route::get('/location', '\App\Http\Controllers\LocationController@getLocation')->name('location');
...
Route::group(['middleware' => ['auth', 'Role'], 'roles' => ['employee']], function () {
    ...
    Route::get('/employee', '\App\Http\Controllers\EmployeesController@index')->name('employee');
    Route::post('/attendance', '\App\Http\Controllers\EmployeesController@attendance')->name('attendance');
    Route::get('/logs', '\App\Http\Controllers\EmployeesController@logs')->name('logs');
    Route::get('/profile', '\App\Http\Controllers\EmployeesController@profile')->name('profile');
...
//Route::get('/attendance', '\App\Http\Controllers\APIController@attendance');
